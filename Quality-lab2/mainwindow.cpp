...
//==================количество методов которые могут вызваны экземпляром класса
...
void MainWindow::on_Metrics_clicked()
{
    ...
    ui->Kol_Met->setText(QString::number(KolvoMetodov(code)));
